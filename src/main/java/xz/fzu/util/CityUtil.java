/**
 * Copyright (C), 2019-2019, supermingjun
 * FileName: CityUtil
 * Author:   MingJun
 * Date:     2019-09-17 04:28
 * Description:
 * History:
...
public class CityUtil {
    ...
    public static String findObjectProvince(String cityName) {
        ...
        cityName = cityName.replace("市","").replace("省","").replaceAll(" ","");
    ...
    public static void main(String[] args) {
        System.out.println(findObjectProvince("深圳"));
    }
